...
missed vcf:      {}
        '''.format(self.tool_name, self.dataset_name, self.get_switch_rate(), self.get_mismatch_rate(),
                   ...
                   self.get_AN50(),self.get_N50(),self.get_max_blk_snp_percent(),self.get_runtime(), not_in))
        return s
...
if __name__ == "__main__":
    ...
    result = hapblock_vcf_error_rate(sys.argv[2], None, sys.argv[1], dataset_name=dataset_name, use_SNP_index=False)
    print(result)
